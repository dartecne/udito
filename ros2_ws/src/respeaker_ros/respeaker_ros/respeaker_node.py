<<<<<<< HEAD
<<<<<<<< HEAD:ros2_ws/src/respeaker_ros/respeaker_ros/respeaker_node.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
if __name__ == '__main__':
    ...
    n = RespeakerNode()
    rospy.spin()
>>>>>>>> d75813b06134359daeaea89edeabe871241fbad3:ros2_ws/src/respeaker_ros/scripts/respeaker_node.py
=======
def main(args=None):
#    rospy.init_node("respeaker_node")
#    n = RespeakerNode()
