...
class Command_Response(metaclass=Metaclass_Command_Response):
    ...
    def rta(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'rta' field must be of type 'str'"
        self._rta = value
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.Command')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from tutorial_interfaces.srv._command import Command_Request as Request
    from tutorial_interfaces.srv._command import Command_Response as Response
